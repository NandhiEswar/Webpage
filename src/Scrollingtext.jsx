...
function Scrollingtext() {
  ...
  return (
      <div className='flex  flex-row md:flex-col justify-center items-center '>
          ...
          <Magnetic>
    <div>
                          <motion.div className='w-[190px] h-[190px] md:w-60 md:h-60 rounded-full  bg-black flex justify-center text-center mt-48  z-[-1] mr-56 md:mr-0  md:mt-0 items-center cursor-pointer  text-white hover:bg-[#455CE9]
        
         '
            style={{ y: translateY }}>
            {/* Wrap the text with motion */}
            <motion.p className='md:p-10 p-5 text-3xl font-wixmadefor ' initial={{ x: 0, y: 0 }}>
