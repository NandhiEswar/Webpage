      ...
      <div style={{ y }} ref={container} className='   bg-[#141516] text-white justify-center items-center ' >
          <div className=' flex flex-col justify-center items-center  gap-10'>
            ...
            {child}
              ...
              <motion.div  className=' items-center justify-end w-1/2 md:h-1 vsm:h-[0.8px] bg-[#A5A5A5] flex  my-12 container mt-28'>
              ...
              <div className='flex md:gap-20 sm:gap-16 vsm:gap-11 mt-10 md:flex-row sm:flex-row vsm:flex-col '>
                  {/* buttons */}
                  <Magnetic>
              <motion.div className=" border rounded-xl md:p-5 vsm:p-3  border-[#C3B091] hover:bg-[#455CE9]">
                  ...
                  <Magnetic>
              <motion.div className=" border rounded-lg md:p-5  vsm:p-3 border-[#C3B091] hover:bg-[#455CE9]">
          ...
          <div className='flex ml-10 mt-56 flex-row justify-between items-center'>
